...
func conversionTests() []conversionTest {
	...
	return []conversionTest{
		...
		{s: "1.5", d: new(userDefined), wantusrdef: 1.5},
		{s: []byte{1, 2, 3}, d: new(userDefinedSlice), wanterr: `unsupported Scan, storing driver.Value type []uint8 into type *main.userDefinedSlice`},
...
func TestDriverArgs(t *testing.T) {
	var nilValuerVPtr *ValuerV
	var nilValuerPPtr *ValuerP

...
func TestGenericArrayScanScannerArrayBytes(t *testing.T) {
	src, expected, nsa := []byte(`{NULL,abc,"\""}`),
		[3]NullString{{}, {String: `abc`, Valid: true}, {String: `"`, Valid: true}},
		[3]NullString{{String: ``, Valid: true}, {}, {}}
...
func TestGenericArrayScanScannerArrayString(t *testing.T) {
	src, expected, nsa := `{NULL,"\"",xyz}`,
		[3]NullString{{}, {String: `"`, Valid: true}, {String: `xyz`, Valid: true}},
		[3]NullString{{String: ``, Valid: true}, {}, {}}
...
func TestGenericArrayScanScannerSliceNil(t *testing.T) {
	nss := []NullString{{String: ``, Valid: true}, {}}
...
func TestGenericArrayScanScannerSliceBytes(t *testing.T) {
	src, expected, nss := []byte(`{NULL,abc,"\""}`),
		[]NullString{{}, {String: `abc`, Valid: true}, {String: `"`, Valid: true}},
		[]NullString{{String: ``, Valid: true}, {}, {}, {}, {}}
...
func TestGenericArrayScanScannerSliceString(t *testing.T) {
	src, expected, nss := `{NULL,"\"",xyz}`,
		[]NullString{{}, {String: `"`, Valid: true}, {String: `xyz`, Valid: true}},
		[]NullString{{String: ``, Valid: true}, {}, {}}
...
type TildeNullInt64 struct{ NullInt64 }
...
func TestGenericArrayScanDelimiter(t *testing.T) {
	src, expected, tnis := `{12~NULL~76}`,
		[]TildeNullInt64{{NullInt64{Int64: 12, Valid: true}}, {}, {NullInt64{Int64: 76, Valid: true}}},
		[]TildeNullInt64{{NullInt64{Int64: 0, Valid: true}}, {}}
...
func TestGenericArrayValue(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{`{NULL}`, []NullString{{}}},
		{`{"\"",NULL}`, []NullString{{String: `"`, Valid: true}, {}}},
